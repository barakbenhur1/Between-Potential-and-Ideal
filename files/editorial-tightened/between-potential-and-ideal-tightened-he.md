...
25. [3. N P : עדות שאפשר לבדוק, לא
    “בעיות קשות”](#3.-N-P--עדות-שאפשר-לבדוק-לא-בעיות-קשות)
26. [4. רדוקציות ו־ N P -שלמות: כאשר קושי מתרכז
...
54. [משפט של פוטנציאל](#משפט-של-פוטנציאל)
...
![איור ה: המבנה הרקורסיבי במודל הלוגי. מקור, פלטפורמה, מודל, עולם, סשן ומשימה.](../../figures/cover_logical_recursion_whole_diagram.png)
