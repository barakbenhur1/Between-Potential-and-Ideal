...
1. Keep the absolute, ideal, optimal, and living completeness distinct.
2. Preserve the ideal as a critical horizon, not private taste or frozen command.
3. Keep the optimal as local translation, not compromise without conscience.
4. Preserve distance as the birthplace of responsibility rather than a defect to erase.
5. Normalize all completeness, translation, horizon, and moral vocabulary under one Neo-Quenya profile.
