...
1. Preserve metaphor, model, structural comparison, and scientific claim as distinct levels.
2. Keep all scientific references explicitly bounded by domain of validity.
3. Do not treat formulas or diagrams as proof without measurement and failure conditions.
4. Preserve science as living institutional work, not borrowed prestige.
5. Normalize all science, physics, mathematics, model, claim, and evidence terminology under one Neo-Quenya profile.
