...
1. Preserve selfhood without turning it into absolute ownership.
2. Distinguish ego correction from self-destruction.
3. Keep transparency distinct from disappearance.
4. Preserve unity without uniformity and humility without erasure.
5. Normalize all self, ego, boundary, embodiment, memory, and relinquishment vocabulary under one Neo-Quenya profile.
