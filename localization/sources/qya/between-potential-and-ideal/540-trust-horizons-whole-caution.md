...
1. Mark event horizons of trust as conceptual metaphors, never moral or social physics.
2. Preserve the distinction between a person and the relation through which new information can no longer pass.
3. Keep every domain example: intimate betrayal, law after sentence, economic credit, digital archives, groups, institutions, art, and language.
4. Preserve refusal as sometimes protective; repair must not promise restored trust or return to the outside.
5. Keep “God” as one cautious possible name for the Whole, never a particle mover, miracle operator, physical force, black-hole punishment, or white-hole body.
6. Preserve all explicit statements that scientific examples mirror but do not prove the theory.
7. End with Ideal as an appearance that does not betray the Potential from which it came.
8. Normalize trust, interpretation, archive, frozen identity, repair, redemption, God, Whole, source, mirror, and justification terminology under one Neo-Quenya profile.