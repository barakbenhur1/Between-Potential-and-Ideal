...
I methodological safeguard maura ná no-signalling: quantum correlations polir ná non-classical, mal lá polir ná used sendien controlled information faster than light. Correlation lá ná communication tië communicationo. Relation lá ná control. Dependence lá necessarily ná direct moral responsibility.
...
1. Keep locality physical first and structural only by explicit extension.
2. Preserve no-signalling and the distinction between correlation and communication.
3. State Bell carefully under its assumptions.
4. Reject telepathy, instant messaging, and popular mystical overreach.
5. Normalize all locality, non-locality, correlation, signalling, and Bell terminology under one Neo-Quenya profile.
