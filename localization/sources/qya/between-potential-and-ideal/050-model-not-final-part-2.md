...
1. Preserve every explicit stopping condition.
2. Keep the living source before the model and testimony above extracted data.
3. Preserve the criticism/drainage metaphor without turning it into formal science.
4. Keep AI as mirror and critic, not authority or living owner.
5. Normalize all terms under one declared Neo-Quenya profile before publication.
