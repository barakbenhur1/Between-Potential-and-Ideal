...
1. Preserve the four help roles: replace, hint, hold, release.
2. Keep AI as scaffold, mirror, checker, practice tool, or temporary witness—not the learner's living source.
3. Preserve the diagnostic formula as metaphor, not numerical psychology.
4. Keep difficulty only while it forms understanding; stop when it begins to erase the learner.
5. Normalize all education, formation, assessment, scaffold, and ownership vocabulary under one Neo-Quenya profile.
