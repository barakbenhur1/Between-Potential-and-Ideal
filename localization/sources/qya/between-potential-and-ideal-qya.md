...
This canonical source remains `draft` until:

1. one declared Neo-Quenya grammar profile is selected and applied consistently;
2. every community formation and project compound is approved, replaced, or explicitly labeled;
3. the approved glossary stabilizes Potential, Ideal, Optimal, witness, source, distance, friction and responsibility;
4. every chapter is compared against both the English source and Hebrew semantic cross-check;
5. all images, captions, quotations, links and protected literary details are preserved;
6. the source status changes to `approved` only after the complete document passes content and linguistic review.
