...
1. Preserve that high-energy physics does not prove the QubmeH mIw and does not identify Potential with energy, Ideal with symmetry, or Optimal with force unification.
2. Keep high energy an experimental condition, never Hap chut HurDaq depth or moral superiority.
3. Preserve appearance as trace read through event, detector, background, filtering, mI' De' poj, model, and interpretation.
