...
1. Preserve AI as a machine that expands potential but cannot replace the ideal or own the invariant.
2. Keep consent, living source, attribution, and responsibility explicit when voice, style, or character are imitated.
3. Preserve refusal and abstention as possible optimal forms; technical ability is never moral permission.
4. Keep false ideal distinct from genuine liberation.
5. Preserve genres as systems of questions, not collections of surface signs.
6. End with the exact conceptual triad: potential is everything the work can be; ideal is what it must not lose; optimal is faithful relinquishment.
7. Review all AI, consent, refusal, abstention, false-ideal, genre, and faithful-relinquishment terminology before publication.