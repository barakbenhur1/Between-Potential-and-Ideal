...
1. Preserve source, risk, form, and responsible deletion as one living relation.
2. Do not romanticize flaw, fracture, suffering, or manual labor.
3. Keep AI as a real creative tool that can either extend or replace formation.
4. Preserve canon as memory tested through time, not authority by itself.
5. Keep the market as an enabling and deforming force, never the final judge.
6. Review all art, source, effect, formation, deletion, canon, market, and automation terminology before publication.