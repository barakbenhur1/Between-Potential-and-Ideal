...
1. a Klingon specialist reviews grammar and vocabulary;
2. the approved glossary stabilizes Potential, Ideal, Optimal, witness, source, distance, friction and responsibility;
3. every chapter is compared against both the English source and Hebrew semantic cross-check;
4. all images, captions, quotations, links and protected literary details are preserved;
5. the source status changes to `approved` only after the complete document passes content and linguistic review.
