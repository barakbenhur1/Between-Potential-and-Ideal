(function(){
  ...
  function langHref(){
    const current = key();
    if (isHe()) return isInner() ? '../en/' + (heToEn[current] || 'en.html') : (heToEn[current] || 'en.html');
    return isInner() ? '../he/' + (enToHe[current] || 'index.html') : (enToHe[current] || 'index.html');
  }
  ...
  function installFinalTabbarDimensions(){
    replaceStyle('bpi-final-tabbar-dimensions', [
      ...
      '@media(min-width:1500px){html body.public-page-he.bpi-home-page .site-header{grid-template-columns:248px minmax(0,1240px) 104px!important;}html body.public-page-he.bpi-home-page .site-header .site-nav{max-width:1240px!important;flex-wrap:nowrap!important;gap:3px!important;}html body.public-page-he.bpi-home-page .site-header .site-nav a{padding-inline:9px!important;font-size:13px!important;}}',
      '@media(min-width:861px) and (max-width:1499px){html body.public-page-he.bpi-home-page .site-header{height:auto!important;min-height:92px!important;max-height:none!important;grid-template-columns:minmax(190px,248px) minmax(0,1fr) minmax(88px,104px)!important;padding-block:8px!important;}html body.public-page-he.bpi-home-page .site-header .site-nav{max-width:100%!important;flex-wrap:wrap!important;gap:3px 2px!important;}html body.public-page-he.bpi-home-page .site-header .site-nav a{padding-inline:6px!important;font-size:12.5px!important;}}',
      '@media(max-width:1180px){html body.public-page:not(.bpi-home-page) .site-header{grid-template-columns:210px minmax(0,1fr) 92px!important;}html body.public-page .site-header .site-brand{width:210px!important;min-width:210px!important;max-width:210px!important;}html body.public-page .site-header .language-switch{width:92px!important;min-width:92px!important;max-width:92px!important;}html body.public-page .site-header .site-nav a{font-size:13px!important;padding:8px 10px!important;}}',
  ...
  function enforceExactLabels(nav, he){
    nav.querySelectorAll('a').forEach((link) => {
      ...
      if (he && rawHref.endsWith('ai.html')) link.textContent = 'בינה מלאכותית';
      if (he && rawHref.endsWith('ai-as-witness.html')) link.textContent = 'בינה מלאכותית כעדות';
      if (!he && rawHref.endsWith('ai-en.html')) link.textContent = 'AI';
      if (!he && rawHref.endsWith('ai-as-witness-en.html')) link.textContent = 'AI as Witness';
    });
  }
  ...
  function renderNav(){
    ...
    lang.setAttribute('aria-label', he ? 'Switch to the English version' : 'מעבר לגרסה העברית');
    lang.title = he ? 'English version' : 'גרסה עברית';
