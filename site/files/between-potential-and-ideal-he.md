...
<p class="toc-sub"><a href="#זהו-מודל-לא-הכרזה-סופית">זהו מודל, לא הכרזה סופית</a></p>
...
44. [3. NP : עדות שאפשר לבדוק, לא “בעיות
    קשות”](#3.-NP--עדות-שאפשר-לבדוק-לא-בעיות-קשות)
45. [4. רדוקציות ו־ NP -שלמות: כאשר קושי מתרכז
    בצומת](#4.-רדוקציות-ו־-NP--שלמות-כאשר-קושי-מתרכז-בצומת)
46. [5. coNP: הצד המשלים של העדות](#5.-coNP--הצד-המשלים-של-העדות)
...
48. [7. QBF ו־ PSPACE : כאשר פתרון נעשה
    אסטרטגיה](#7.-QBF-ו־-PSPACE--כאשר-פתרון-נעשה-אסטרטגיה)
...
![איור פרק: זהו מודל, לא הכרזה סופית](../figures/cover_philosophical_recursion_whole_diagram.png)

*תיאור תמונה: מפה של יחסים, לא הכרזה סופית ולא מציאות סגורה.*
...
תיאור תמונה: הבחנה מוסרית בין כאב, רוע, אחריות ותיקון בלי לקדש את הסבל.
