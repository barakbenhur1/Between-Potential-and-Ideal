...
_תיאור תמונה: מפת־על של התאוריה — פוטנציאל, אידיאל, חיכוך, מרחק וניווט בתוך אי־ודאות._
...
![איור פרק: זהו מודל, לא הכרזה סופית](../figures/chapter_model_not_final_declaration_v1.png)

_תיאור תמונה: מבנה רעיוני חצי־גמור, מצפן ודרך פתוחה אל אופק מואר; הדימוי מדגיש שמדובר במודל אחראי, זמני וניתן לביקורת, לא בהכרזה סופית._
...
לחיצה על כל סעיף תגלול ישירות למקום המתאים במסמך. פרקים ראשיים צמודים לצד השפה; תתי־כותרות מוזחות פנימה.
...
- אלוהים כפוטנציאל והסיכון האלוהי

- האבסולוטי, האידיאלי והשלמות החיה

- התנועה המרכזית - הכותרת, הנהר והסירה

- חוויה, ידע והדרך שאין לעקוף

- חינוך של פוטנציאל

- משמעת מקורות

- גלגול נשמות כידיעה איטרטיבית, לא כקידום מוסרי

- עצמי, אגו ואחדות שאינה מוחקת

- רוע, סבל, טוב ואחריות

- הבינה המלאכותית כראי והקיום כניווט
...
- המבנה הרקורסיבי האינסופי וההתגלות הפנימית

- כשל האיפוס: כוח המשיכה של הבסיס
...
- כיוון הירידה: היררכיית ההכלה המדורגת
...
- מנגנון האיטרציה, האיפוס ומערך האידיאלים
...
- הקיום כאלוהים על ספת הפסיכולוג
...
- כיוון העלייה: התכנסות מדורגת וההתגלות הפנימית
...
- חישוב, עדות, רדוקציה ואי־שלמות

- בעיה כשפה: מה בכלל עומד להכרעה?

- מכונת טיורינג: מה נחשב חישוב?

- NP : עדות שאפשר לבדוק, לא “בעיות קשות”

- רדוקציות ו־ NP -שלמות: כאשר קושי מתרכז בצומת

- coNP : הצד המשלים של העדות

- ההיררכיה הפולינומית: מעדות אחת לשכבות של כימות

- QBF ו־ PSPACE : כאשר פתרון נעשה אסטרטגיה

- אלגברה ליניארית: מצב, פעולה ופירוק

- לכסון מטריצות: איור של שינוי בסיס

- שני סוגים של אלכסון: פירוק מול גבול

- גדל: מערכת שאינה יכולה לסגור את עצמה

- האדם, המערכת והמטא־רמה

- מפה אחת: ייצוג, מעבר, משאב, עדות, גבול

- סיום: אידיאל שאינו סגירה
...
- משפטי בל, קוכן־ספקר, המכניקה הבוהמית והזהירות שלא להפוך פיזיקה לסיסמה
...
- חומר: הפוטנציאל עם גבול

- עומס: המציאות שנכנסת אל הצורה

- מקדם ביטחון: הכרה בכך שאיננו אלוהים

- מאמץ ומעוות: איך חומר מספר שכואב לו

- סדק: אמת קטנה לפני קריסה גדולה

- יסודות: מה שאינו נראה מחזיק את מה שכן

- ארכיטקטורה: צורה שאנשים חיים בתוכה

- פונקציה וצורה: מי משרת את מי?

- תנועה: איך מבנה חושב דרך הגוף

- אור: החומר שאינו חומר

- תהודה: כאשר מבנה וקצב נפגשים

- יתירות: לא כל עודף הוא בזבוז

- תחזוקה: האמת שאחרי הפתיחה

- כשל: כאשר האידיאל פוגש את מה שהשאיר בחוץ

- ארכיטקטורה של אחריות

- יופי: לא קישוט, אלא יחס נכון

- עיר: מבנה של פוטנציאלים מתנגשים

- נוסחת המבנה של הפוטנציאל

- תיקון הנדסי שאינו גאולה

- כלכלה של יחס

- אין “למעלה” ו“למטה” מוחלטים

- כסף: פוטנציאל נייד

- זהב, פיאט והחיפוש אחרי קרקע

- כוח קנייה: מה הסימן עדיין פותח

- שער חליפין ריאלי: יחס בתוך יחס

- אינפלציה: כשהסימן מתחיל לדבר חלש

- השוק: מראה, לא אלוהים

- אשראי וחוב: העתיד שנכנס אל ההווה

- ריבית: מחיר הזמן, מחיר הסיכון

- עבודה: פוטנציאל שעובר דרך גוף

- רווח: יצירה או חילוץ

- חיצוניות: מה שהמחיר השאיר בחוץ

- אי־שוויון: כאשר התוצאה הופכת לאפשרות

- בועה: כאשר המחיר בורח מן המציאות

- צמיחה: יותר ממה?

- משבר: כאשר התווך מפסיק להחזיק

- נוסחת הערך של הפוטנציאל

- תיקון כלכלי שאינו גאולה

- ממשל של פוטנציאל

- מצב טבע אינו רק עבר; הוא אפשרות תמידית

- חוק: צורה שמגבילה כוח כדי לאפשר חירות

- לגיטימיות: למה אנשים מסכימים להישמע

- ריבונות: מי מחזיק את ההחלטה האחרונה?

- הפרדת רשויות: לא אמון עיוור, אלא חשד מתוכנן

- בחירות: מדידת רצון שאינה זהה לאמת

- זכויות: גבולות שהחברה מציבה לעצמה

- חובות: הצד השני של האפשרות

- מוסד: זיכרון ציבורי עם אחריות

- בירוקרטיה: כשהצורה שוכחת את החיים

- שחיתות: כאשר התווך נמכר מבפנים

- מסים: אמון שנגבה בכפייה

- כוח חוקי: האלימות שהחברה מנסה לקשור

- חירום: הרגע שבו האידיאל מתפתה לוותר על עצמו

- חברה אזרחית: מה שהמדינה אינה יכולה להיות במקומנו

- שפה ציבורית: המקום שבו חברה חושבת בקול

- רוב ומיעוט: מבחן הכוח שלא צריך הכול

- מדיניות ציבורית: הרצון שפוגש ביצוע

- מדידה: מה שנכנס למדד ומה שנשאר בחוץ

- נוסחת הממשל של הפוטנציאל

- תיקון שלטוני שאינו גאולה
...
- מפת השוואות פיזיקלית — פוטנציאל, צורה והחיפוש אחר תאוריה מאוחדת
...
![איור פרק: השלם, החיכוך והיווצרות חיה](../figures/10_living_wholeness.png)

_תיאור תמונה: השלם אינו מוחק את חלקיו; החיכוך ביניהם יוצר יחס, צורה חיה ואחריות._
...
![איור פרק: עדות, תדר, מראה והכרה הדדית](../figures/v26_restyle_dual_lenses_resonance.png)

_תיאור תמונה: עדות, הדהוד ומראה — הכרה באמת בלי לבטל את המרחק מן המקור החי._
...
![איור א: הפיצול התודעתי של האחד. מן שלמות פוטנציאלית אל ריבוי נקודות מבט.](../figures/tab_methodology.png)

_איור א: הפיצול התודעתי של האחד. מן שלמות פוטנציאלית אל ריבוי נקודות מבט._
...
_איור ב: האבסולוטי אינו האידיאלי. כל האפשרויות מול הצורה הראויה._
...
_איור ג: הנהר והסירה. תנועה בין פוטנציאל לאידיאל דרך ניווט חי._
...
_איור ד: חוויה וחומריות. ידע שאי אפשר לדלג מעליו._
...
_איור ה: גלגול נשמות כאיטרציה של למידה, שכחה ואינטגרציה._
...
![פרק ו: עצמי, אגו ואחדות שאינה מוחקת](../figures/14_self_ego_unity.png)

_פרק ו: עצמי, אגו ואחדות שאינה מוחקת_
...
_תיאור תמונה: נקודת מבט נשמרת בתוך שלם, בלי להיבלע ובלי להתנתק._
...
_איור ח: הבינה כראי. מרחק, מקור ושיקוף._
...
![איור ה: המבנה הרקורסיבי. כל שכבה יכולה להפוך למקור, למרחב, לאפשרות ולעולם מקומי.](../figures/v25_chapter_recursive-edge.png)

_איור ה: המבנה הרקורסיבי. כל שכבה יכולה להפוך למקור, למרחב, לאפשרות ולעולם מקומי._
...
_תיאור תמונה: נוסחאות, מדידה ומודלים כשפות גבול, לא כהוכחה סופית._
...
Built Value = Potential × Material Capacity × Form Coherence × Human Use ———————————————————– Load × Friction × Wear × Uncertainty
...
Value is never only a number. Value is a number inside a reference system.
...
Price growth exceeds fundamentals and Purchase depends increasingly on resale expectations
...
Economic Value = Potential × Trust × Meaningful Scarcity × Coordination ——————————————————– Friction × Uncertainty × Distortion
...
Governed Potential = Human Potential × Lawfulness × Institutional Trust × Civic Participation × Corrective Capacity ———————————————————————————————– Unjustified Coercion × Corruption × Fear × Administrative Friction × Information Distortion
...
_איור ו: המדומה, הווירטואלי והאופק. גבול כמבנה של יחס ולא כקיר פשוט._
...
_איור ז: מסה־אנרגיה ותווך. צורה, אור וחומר כשלוש שפות של מעבר._
...
![איור ח: מפת השוואות פיזיקלית. קוונטים, יחסות, אופק ומידע כשפות שונות של אותו מתח בין פוטנציאל וצורה.](../figures/05_flow_toward_the_ideal.png)

_איור ח: מפת השוואות פיזיקלית. קוונטים, יחסות, אופק ומידע כשפות שונות של אותו מתח בין פוטנציאל וצורה._
